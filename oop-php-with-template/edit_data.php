                    ...
                    <div class="col-10 col-md-10 col-lg-7 col-xl-6">
                        <div class="card card-primary shadow-sm">
                            <div class="card-header">
                                <h5 class="card-title m-1 h5 font-weight-bold text-center text-primary">EDIT DATA
                                    WARGA ID : <?= $update["id"]; ?></h5>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="index.php" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap"
                                            rows="3"><?= $update["alamat_lengkap"]; ?></textarea>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                                ...
                                <center>
                                    ...
                                    <div class=" card-footer">
                                        <a href="index.php" class="btn btn-danger font-weight-bold m-1"><svg
                                        ...
                                        <button type="submit" name="simpan_update"
